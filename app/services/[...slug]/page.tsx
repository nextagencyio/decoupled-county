...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!item) {
    return { title: 'Service Not Found | County' }
  }
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <dl className="space-y-4">
                  {(item as any).onlineUrl && (
                    <div>
                      <dt className="text-sm text-gray-500">Online Service URL</dt>
                      <dd className="font-semibold text-gray-900">{(item as any).onlineUrl}</dd>
                    </div>
                  )}
                  ...
                  {(item as any).fee && (
                    <div>
                      ...
                      <dd className="font-semibold text-gray-900">{(item as any).fee}</dd>
                    </div>
                  )}
                </dl>
                <div className="mt-8">
