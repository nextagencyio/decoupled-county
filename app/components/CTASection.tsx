...
export default function CTASection({ homepageContent }: CTASectionProps) {
  const title = (homepageContent as any)?.ctaTitle || 'Stay Connected with Greenfield County'
    ...
    <section className="bg-primary-100 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <a href="/contact" className="px-8 py-3 bg-primary-800 text-white rounded hover:bg-primary-900 transition-colors font-bold">
            {primaryLabel}
          </a>
          <a href="/services" className="px-8 py-3 border-2 border-primary-800 text-primary-800 rounded hover:bg-primary-800 hover:text-white transition-colors font-bold">
            {secondaryLabel}
          </a>
        </div>
      </div>
