...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Riverside County. We\'d love to hear from you about county services, permits, or public records.',
  keywords: ['Contact Riverside County', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about county services, permits, or public records? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@riversidecounty.gov</p>
                    <p className="text-gray-600">support@riversidecounty.gov</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 789-0102</p>
